...
def main():
    ...
    for i in list(topics.keys()):
        ...
        randomly_selected_relevant_message = random_sample_of_message_ids(all_relevant_messages) # an integer
        ...
        print('At the end of for loop; found the message number %s for the topic.' % randomly_selected_relevant_message)
    print('Here is the list of the selected messages in order of the topic dict: %s ' % list_of_relevant_messages_in_all_topics)
